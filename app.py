...
if uploaded_files and api_key:
    ...
    st.warning("API-ключ не задан. Укажите его в боковой панели.")
elif not uploaded_files:
    st.info(
        "Ключ задан. При необходимости замените его в боковой панели. "
        "Загрузите один или несколько аудиофайлов."
    )
